...
public interface Rabbit {
     ...
     * @return 开放平台接口实例
     */
    Rabbit addEventListener(EventListener listener);
     ...
     * @return 开放平台接口实例
     */
    Rabbit removeEventListener(EventListener listener);

    /**
     * Rabbit 软件全名带版本号
     *
     * @return 软件全名带版本号
     * @see Rabbit#RABBIT_NAME
     * @see Rabbit#getRabbitVersion()
     * @see Rabbit#getRabbitVersionInteger()
     */
     ...
     * @return 版本号
     * @see Rabbit#RABBIT_NAME
     * @see Rabbit#getSoftwareFullName()
     * @see Rabbit#getRabbitVersionInteger()
     */
